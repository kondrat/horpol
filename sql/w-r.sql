...
REPLACE INTO `brands` (`id`, `name`, `url`, `logo`, `body`, `created`, `modified`) VALUES
	('1','b777','','Boeing_777_21.jpg','<p><span style="background-color: Lime;">this is a boeing 777</span> just for test So, this is a boeing 777 <strike><u><em><strong>just for test this is a boeing</strong></em></u></strike> 777 just for test this is a boeing 777 just for test this is a boeing 777 just for test</p>','2008-11-11 01:05:42','2009-03-23 14:41:17'),
	('2','a380','','09430350.jpg',NULL,'2008-11-11 15:04:35','2008-12-09 20:21:20'),
	('3','A320','asus','0_a400_8b53caef_XL1.jpg','this is a boeing 777 just for test So, this is a boeing 777 just for test this is a boeing 777 just for test this is a boeing this is a boeing 777 just for test So, this is a boeing 777 just for test this is a boeing 777 just for test this is a boeing this is a boeing 777 just for test So, this is a boeing 777 just for test this is a boeing 777 just for test this is a boeing','2008-11-17 21:15:15','2009-04-11 13:19:05'),
	('4','a350','farm','a350-21.jpg',NULL,'2008-11-20 12:54:04','2008-12-09 20:20:56'),
	('6','a400','','0_2724b_e379be85_XL1.jpg','','2008-12-08 17:25:28','2009-04-11 13:20:08'),
	('8','for14',NULL,'0_27cfe_2f84ca06_XL0.jpg','','2008-12-12 21:22:10','2009-04-11 13:20:16'),
	('9','dsfw',NULL,'0_6ca1_31a753d3_XL1.jpg','','2008-12-12 21:23:35','2009-04-11 13:20:23'),
...
REPLACE INTO `categories` (`id`, `type`, `name`, `url`, `title`, `body`, `slogan`, `created`, `modified`) VALUES
	(2,1,'Художественный паркет','','sadf','<p><img src="/app/webroot/files/0_25ce0_6c8c77f3_orig.jpg" alt="" /><br />\r\n&nbsp;</p>\r\n<p>&nbsp;</p>\r\n<p><em><strong>More</strong></em> <em>text</em> g<u><em>oes</em></u> <strong><em>here</em></strong>. <strike>vot blin</strike></p>\r\n<p>&nbsp;</p>\r\n<p>&nbsp;</p>\r\n<p>&nbsp;</p>\r\n<p>&nbsp;</p>\r\n<p>&nbsp;</p>',' Здесь только лучшее от природы и производителей Каждая фабрика-яркая индивидуальность','2008-11-11 14:04:12','2009-09-04 20:25:55'),
	...
	(24,2,'sdf',NULL,'','','Здесь только лучшее от природы и производителей. <br />Каждая фабрика-яркая индивидуальность','2009-09-04 20:29:26','2009-09-04 20:29:52');
...
REPLACE INTO `news` (`id`, `name`, `body`, `created`) VALUES
	...
	(5,'brand new news','<p><em>bla</em> bla<a href="http://mail.ru"> bla</a>&nbsp;<img alt="" src="http://localhost/horpol/js/fck/editor/images/smiley/msn/angry_smile.gif" /> &nbsp;&nbsp; KOttRdr &nbsp; fHHHHH sdfdsf</p>','2009-03-24 00:00:00');
...
REPLACE INTO `sub_categories` (`id`, `category_id`, `brand_id`, `active`, `name`, `url`, `images`, `product_count`, `created`, `modified`) VALUES
	(19,'2','1',1,'sdfdd','dsdfg',NULL,'4','2008-11-19 15:04:19','2008-11-19 15:04:19'),
...
REPLACE INTO `users` (`id`, `username`, `password`, `role`, `email`, `active`, `created`) VALUES
	('1','kondrat','c129b324aee662b04eccf68babba85851346dff9','admin','',0,'0000-00-00 00:00:00'),
