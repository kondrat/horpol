	...
	function admin_index() {		
		...
		switch($case) {
			...
			case 2:
				...
				$subCategories = $this->SubCategory->BrandsCategory->find('all',array('conditions'=>array('BrandsCategory.category_id'=>$this->params['named']['cat'],'BrandsCategory.brand_id'=>$this->params['named']['brand']),
